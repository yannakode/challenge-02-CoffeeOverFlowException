...
public class OrderServiceTest {
    ...
    public void getAllOrders_WithoutStatus_ReturnsOrderResponseDTOList() {
        ...
        Assertions.assertThat(orderResponseDTOList)
        ...
        Assertions.assertThat(resultOrderResponseDTO.getId()).isEqualTo(ORDER.getId());
        Assertions.assertThat(resultOrderResponseDTO.getAddress()).isEqualTo(ORDER.getAddress());
        Assertions.assertThat(resultOrderResponseDTO.getDiscount()).isEqualTo(ORDER.getDiscount());
    }
    ...
    public void getAllOrders_WithInvalidStatus_ThrowsInvalidDataException() {
        ...
        try {
            ...
            assertThat(ex.getMessage()).isEqualTo("Invalid status value. Allowed values are CONFIRMED, SENT, CANCELED.");
        }
    }
}
